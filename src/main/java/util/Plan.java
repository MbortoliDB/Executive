...
public interface Plan extends Serializable {
     ...
     */
    TreeMap<Double, Set<IntOp>> actions();
     ...
     *          the time specifier.
     */
    Set<IntOp> getActionSet(final double time);
     ...
     */
    boolean add(final double time, final IntOp action);
     ...
     */
    boolean remove(final double time, final IntOp action);
     ...
     * @return <code>true</code> if the action was removed; <code>false</code> otherwise.
     */
    boolean remove(final double time);
     ...
     */
    boolean contains(final double time, final IntOp action);

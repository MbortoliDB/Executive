...
{if ("" != null) return t;}
  ...
  final public void domain() throws ParseException {Exp node = null;
        Symbol name = null;
    try {
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void domain_and_problem() throws ParseException {Exp node = null;
        Symbol name = null;
    try {
      left_bracket();
      jj_consume_token(DEFINE);
...
this.problem = new Problem(name);
      ...
      if (jj_2_18(2) && (this.isRequirement(RequireKey.HTN))) {
        htn_const();
      } else {
        ;
      }
...
{if ("" != null) return requirements;}
  ...
  final public void type_def() throws ParseException {List<TypedSymbol> typedList = null;
    try {
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public List<TypedSymbol> typed_list(int kind) throws ParseException {Symbol t;
...
tmp.add(t);
      ...
      if (jj_2_20(1) && (this.isRequirement(RequireKey.TYPING))) {
...
tmp.add(t);
      ...
      if (jj_2_21(1) && (this.isRequirement(RequireKey.TYPING))) {
        jj_consume_token(SUB);
        types = type();
        nextTypedList = typed_list(kind);
      } else {
...
tmp.add(t);
      ...
      if (jj_2_22(1) && (this.isRequirement(RequireKey.TYPING))) {
        jj_consume_token(SUB);
        types = type();
        nextTypedList = typed_list(kind);
      } else {
...
{if ("" != null) return typedList;}
  ...
  final public List<Symbol> type() throws ParseException {Symbol s;
...
{if ("" != null) return type;}
  ...
  final public Symbol primitive_type() throws ParseException {Token t = token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OBJECT_TYPE:{
...
{if ("" != null) return new Symbol(Symbol.Kind.TYPE, t);}
    throw new Error("Missing return statement in function");
  }

  final public void constants_def() throws ParseException {List<TypedSymbol> typedList = null;
    try {
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Symbol constant() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SYMBOL:{
      t = jj_consume_token(SYMBOL);
      break;
...
{if ("" != null) return new Symbol(Symbol.Kind.CONSTANT, t);}
    throw new Error("Missing return statement in function");
  }
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public NamedTypedList atomic_formula_skeleton() throws ParseException {Symbol predicate = null;
...
NamedTypedList l = new NamedTypedList(predicate);
  ...
  final public Symbol predicate() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SYMBOL:{
      t = jj_consume_token(SYMBOL);
      break;
...
{if ("" != null) return new Symbol(Symbol.Kind.PREDICATE, t);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol variable() throws ParseException {Token t = token;
    t = jj_consume_token(VARIABLE_SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.VARIABLE, t);}
    throw new Error("Missing return statement in function");
  }
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public NamedTypedList atomic_function_skeleton() throws ParseException {Symbol functor = null;
        List<TypedSymbol> typedList = null;
    left_bracket();
    functor = functor();
    typedList = typed_list(Lexer.VARIABLE);
...
NamedTypedList l = new NamedTypedList(functor);
  ...
  final public Symbol functor() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SYMBOL:{
      t = jj_consume_token(SYMBOL);
      break;
...
{if ("" != null) return new Symbol(Symbol.Kind.FUNCTOR, t);}
    throw new Error("Missing return statement in function");
  }
...
// To keep compatibility with PDDL 3.0: if no type is set it is number
  ...
  final public List<Symbol> function_type() throws ParseException {Token token;
        Symbol symbol;
        List<Symbol> typesList = new ArrayList<Symbol>();
    if (jj_2_26(2) && (this.isRequirement(RequireKey.NUMERIC_FLUENTS)
...
typesList.add(new Symbol(Symbol.Kind.TYPE, token));
    ...
    } else if (jj_2_27(2) && ((this.isRequirement(RequireKey.TYPING) && this.isRequirement(RequireKey.OBJECT_FLUENTS))
                                        || this.isRequirement(RequireKey.FLUENTS))) {
      typesList = type();
{if ("" != null) return typesList;}
    } else {
  ...
  final public Exp con_gd() throws ParseException {Exp node = null;
    if (jj_2_28(2)) {
      node = and_con_gd();
    } else if (jj_2_29(2)) {
      node = forall_con_gd();
...
{if ("" != null) return node;}
  ...
  final public Exp and_con_gd() throws ParseException {Exp conGD = new Exp(Connective.AND);
        Exp child = null;
    left_bracket();
...
{if ("" != null) return conGD;}
  ...
  final public Exp forall_con_gd() throws ParseException {Exp conGD = new Exp(Connective.FORALL);
        Exp child = null;
        List<TypedSymbol> typedList = null;
    left_bracket();
...
conGD.setVariables(typedList);
  ...
  final public Exp at_end_con_gd() throws ParseException {Exp conGD = new Exp(Connective.AT_END);
        Exp node = null;
    left_bracket();
    jj_consume_token(AT);
...
conGD.addChild(node);
  ...
  final public Exp always_con_gd() throws ParseException {Exp conGD = new Exp(Connective.ALWAYS);
        Exp node = null;
    left_bracket();
...
conGD.addChild(node);
  ...
  final public Exp sometime_con_gd() throws ParseException {Exp conGD = new Exp(Connective.SOMETIME);
        Exp node = null;
    left_bracket();
...
conGD.addChild(node);
  ...
  final public Exp within_con_gd() throws ParseException {Exp conGD = new Exp(Connective.WITHIN);
        Token token = null;
        Exp node = null;
    left_bracket();
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp at_most_once_con_gd() throws ParseException {Exp conGD = new Exp(Connective.AT_MOST_ONCE);
        Exp node = null;
    left_bracket();
...
conGD.addChild(node);
  ...
  final public Exp sometime_after_con_gd() throws ParseException {Exp conGD = new Exp(Connective.SOMETIME_AFTER);
        Exp gd1 = null;
        Exp gd2 = null;
    left_bracket();
...
conGD.addChild(gd1);
  ...
  final public Exp sometime_before_con_gd() throws ParseException {Exp conGD = new Exp(Connective.SOMETIME_BEFORE);
        Exp gd1 = null;
        Exp gd2 = null;
    left_bracket();
...
conGD.addChild(gd1);
  ...
  final public Exp always_within_con_gd() throws ParseException {Exp conGD = new Exp(Connective.ALWAYS_WITHIN);
        Token token = null;
        Exp gd1 = null;
        Exp gd2 = null;
    left_bracket();
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp hold_during_con_gd() throws ParseException {Exp conGD = new Exp(Connective.HOLD_DURING);
        Token token1 = null;
        Token token2 = null;
        Exp node = null;
    left_bracket();
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp hold_after_con_gd() throws ParseException {Exp conGD = new Exp(Connective.HOLD_AFTER);
        Token token = null;
        Exp node = null;
    left_bracket();
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp node() throws ParseException {Exp node = null;
    if (jj_2_41(2)) {
      node = atomic_formula(Lexer.TERM);
    } else if (jj_2_42(2)) {
      node = and_gd();
    } else if (jj_2_43(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS))) {
      node = or_gd();
    } else if (jj_2_44(2) && (this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = not_gd();
    } else if (jj_2_45(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS)
                                    && this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = imply_gd();
    } else if (jj_2_46(2) && (this.isRequirement(RequireKey.EXISTENTIAL_PRECONDITIONS))) {
      node = exists_gd();
    } else if (jj_2_47(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_gd();
    } else if (jj_2_48(3) && (this.isRequirement(RequireKey.EQUALITY))) {
      node = equal_gd();
    } else if (jj_2_49(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_comp();
    } else {
...
{if ("" != null) return node;}
  ...
  final public Exp equal_gd() throws ParseException {Exp node = null;
    if (jj_2_50(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp not_equal_atomic_formula() throws ParseException {Exp node = new Exp(Connective.NOT);
        Exp c = null;
    left_bracket();
...
node.addChild(c);
  ...
  final public Exp equal_atomic_formula() throws ParseException {Exp node = new Exp(Connective.EQUAL_ATOM);
...
atom.add(t1);
  ...
  final public Exp and_gd() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp s = null;
    left_bracket();
    jj_consume_token(AND);
    label_11:
...
{if ("" != null) return node;}
  ...
  final public Exp or_gd() throws ParseException {Exp node = new Exp(Connective.OR);
        Exp s = null;
    left_bracket();
    jj_consume_token(OR);
    label_12:
...
{if ("" != null) return node;}
  ...
  final public Exp not_gd() throws ParseException {Exp node = new Exp(Connective.NOT);
        Exp s = null;
    left_bracket();
    jj_consume_token(NOT);
    s = node();
...
node.addChild(s);
  ...
  final public Exp imply_gd() throws ParseException {Exp node = new Exp(Connective.OR);
        Exp p = null;
        Exp q = null;
    left_bracket();
...
Exp not_p = new Exp(Connective.NOT);
  ...
  final public Exp exists_gd() throws ParseException {Exp node = new Exp(Connective.EXISTS);
        List<TypedSymbol> typedList = null;
        Exp s = null;
    left_bracket();
...
node.setVariables(typedList);
  ...
  final public Exp forall_gd() throws ParseException {Exp node = new Exp(Connective.FORALL);
        List<TypedSymbol> typedList = null;
        Exp s = null;
    left_bracket();
    jj_consume_token(FORALL);
...
node.setVariables(typedList);
  ...
  final public Exp atomic_formula(int type) throws ParseException {Exp node = new Exp(Connective.ATOM);
        List<Symbol> atom = new ArrayList<Symbol>();
        Symbol t = null;
    jj_consume_token(LEFT_BRACKET);
    t = predicate();
...
//TODO Gérer les term comme des Exp et propager les changement partout
  final public Symbol term() throws ParseException {Symbol t = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case AT:
    case START:
    case END:
...
Exp literal(int type) throws ParseException {Exp node = null;
    if (jj_2_54(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp not_atomic_formula(int type) throws ParseException {Exp node = new Exp(Connective.NOT);
        Exp s = null;
    left_bracket();
    jj_consume_token(NOT);
...
node.addChild(s);
  ...
  final public Exp f_comp() throws ParseException {Exp node = null;
    node = binary_comp();
{if ("" != null) return node;}
    throw new Error("Missing return statement in function");
  }

  final public Exp binary_comp() throws ParseException {Exp node = null;
    if (jj_2_56(2)) {
      node = greater_comp();
    } else if (jj_2_57(2)) {
      node = less_comp();
...
{if ("" != null) return node;}
  ...
  final public Exp greater_comp() throws ParseException {Exp node = new Exp(Connective.GREATER);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp greater_equal_comp() throws ParseException {Exp node = new Exp(Connective.GREATER_OR_EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp less_equal_comp() throws ParseException {Exp node = new Exp(Connective.LESS_OR_EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp less_comp() throws ParseException {Exp node = new Exp(Connective.LESS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp equal_comp() throws ParseException {Exp node = new Exp(Connective.EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(EQUAL);
...
node.addChild(op1);
  ...
  final public Exp f_exp() throws ParseException {Exp node = new Exp(Connective.F_EXP);
        Exp child = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
      child = number();
...
node.addChild(child);
  ...
  final public Exp number() throws ParseException {Token t = null;
...
Exp node = new Exp(Connective.NUMBER);
  ...
  final public Exp op() throws ParseException {Exp node = null;
    if (jj_2_63(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp binary_operation() throws ParseException {Exp node = null;
    if (jj_2_65(2)) {
      node = add_op();
    } else if (jj_2_66(2)) {
      node = substract_op();
...
{if ("" != null) return node;}
  ...
  final public Exp add_op() throws ParseException {Exp node = new Exp(Connective.PLUS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp substract_op() throws ParseException {Exp node = new Exp(Connective.MINUS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(SUB);
...
node.addChild(op1);
  ...
  final public Exp multiply_op() throws ParseException {Exp node = new Exp(Connective.MUL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp divide_op() throws ParseException {Exp node = new Exp(Connective.DIV);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp unary_op() throws ParseException {Exp node = new Exp(Connective.UMINUS);
        Exp op1 = null;
    left_bracket();
    jj_consume_token(SUB);
    op1 = f_exp();
...
node.addChild(op1);
  ...
  final public Exp f_head() throws ParseException {Exp node = new Exp(Connective.FN_HEAD);
...
node.setAtom(tokenList);
  ...
  final public void structure_def() throws ParseException {Op op = null;
        Method meth = null;
        DerivedPredicate dp = null;
    if (jj_2_70(2)) {
      op = action_def();
this.domain.addOperator(op);
    } else if (jj_2_71(2) && (this.isRequirement(RequireKey.HTN))) {
      meth = method_def();
this.domain.addMethod(meth);
    } else if (jj_2_72(2) && (this.isRequirement(RequireKey.DURATIVE_ACTIONS))) {
      op = durative_action_def();
this.domain.addOperator(op);
    } else if (jj_2_73(2) && (this.isRequirement(RequireKey.DERIVED_PREDICATES))) {
      dp = derived_def();
this.domain.addDerivedPredicate(dp);
  ...
  final public DerivedPredicate derived_def() throws ParseException {NamedTypedList head = null;
        Exp body = null;
    try {
      jj_consume_token(LEFT_BRACKET);
...
{if ("" != null) return new DerivedPredicate(head, body);}
    throw new Error("Missing return statement in function");
  }

  final public Op action_def() throws ParseException {Symbol name = null;
...
{if ("" != null) return new Op(name, parameters, preconds, effects);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol action_name() throws ParseException {Token t = token;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.ACTION, t);}
    throw new Error("Missing return statement in function");
  }

  final public Method method_def() throws ParseException {Symbol name = null;
        List<TypedSymbol> parameters = null;
        Exp tasks = null;
...
{if ("" != null) return new Method(name, parameters, tasks, constraints);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol method_name() throws ParseException {Token t = token;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.METHOD, t);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol task_name() throws ParseException {Token t = token;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.TASK, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp task_def() throws ParseException {Symbol name = null;
    Symbol alias = null;
...
node.setAtom(atom);
  ...
  final public List<Symbol> task_parameters() throws ParseException {List<Symbol> atom = new ArrayList<Symbol>();
        Symbol t = null;
    label_16:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return atom;}
  ...
  final public Exp task_list() throws ParseException {Exp tasks = new Exp(Connective.EXPANSION);
    Exp t = null;
    try {
      label_17:
      while (true) {
...
{if ("" != null) return tasks;}
  ...
  final public Exp htn_constraints() throws ParseException {Exp constraints = new Exp(Connective.AND);
    Exp child = null;
    try {
      jj_consume_token(AND);
      label_18:
...
{if ("" != null) return constraints;}
  ...
  final public Exp task_const() throws ParseException {Exp node = null;
    if (jj_2_74(2)) {
      node = htn_before();
    } else if (jj_2_75(2)) {
      node = htn_hold_before();
    } else if (jj_2_76(2)) {
      node = htn_hold_after();
    } else if (jj_2_77(2)) {
      node = htn_hold_between();
    } else if (jj_2_78(2)) {
      node = htn_hold_during();
    } else if (jj_2_79(3)) {
      node = htn_at_start();
    } else if (jj_2_80(3)) {
      node = htn_at_end();
...
{if ("" != null) return node;}
  ...
  final public Exp htn_before() throws ParseException {Exp node = new Exp(Connective.BEFORE);
        Exp first;
        Exp second;
    left_bracket();
...
{if ("" != null) return node;}
  ...
  final public Exp htn_hold_before() throws ParseException {Exp node = new Exp(Connective.HOLD_BEFORE);
        Exp first;
        Exp second;
    left_bracket();
...
{if ("" != null) return node;}
  ...
  final public Exp htn_hold_after() throws ParseException {Exp node = new Exp(Connective.HOLD_AFTER);
        Exp first;
        Exp second;
    left_bracket();
    jj_consume_token(HOLD_AFTER);
...
{if ("" != null) return node;}
  ...
  final public Exp htn_hold_between() throws ParseException {Exp node = new Exp(Connective.HOLD_BETWEEN);
        Exp first;
        Exp second;
        Exp third;
    left_bracket();
...
{if ("" != null) return node;}
  ...
  final public Exp htn_hold_during() throws ParseException {Exp node = new Exp(Connective.HOLD_DURING);
        Exp first;
        Exp second;
        Exp third;
    left_bracket();
...
{if ("" != null) return node;}
  ...
  final public Exp htn_at_start() throws ParseException {Exp node = new Exp(Connective.AT_START);
        Exp first;
    left_bracket();
    jj_consume_token(AT);
...
{if ("" != null) return node;}
  ...
  final public Exp htn_at_end() throws ParseException {Exp node = new Exp(Connective.AT_END);
        Exp first;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(END);
...
{if ("" != null) return node;}
  ...
  final public Exp htn_within() throws ParseException {Exp node = new Exp(Connective.WITHIN);
        Exp first;
        Exp second;
    left_bracket();
    jj_consume_token(WITHIN);
...
{if ("" != null) return node;}
  ...
  final public Exp htn_always_within() throws ParseException {Exp node = new Exp(Connective.ALWAYS_WITHIN);
        Exp first;
        Exp second;
        Exp third;
    left_bracket();
...
{if ("" != null) return node;}
  ...
  final public Symbol alias_name() throws ParseException {Token t = token;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.ALIAS, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp alias_set() throws ParseException {Exp node = new Exp(Connective.ALIAS_SET);
    List<Symbol> atom = new ArrayList<Symbol>();
    Symbol t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SYMBOL:{
...
node.setAtom(atom);
  ...
  final public Exp pre_gd() throws ParseException {Exp node = null;
    if (jj_2_88(3) && (this.isRequirement(RequireKey.PREFERENCES))) {
      node = pref_gd();
    } else if (jj_2_89(2)) {
      node = and_pre_gd();
    } else if (jj_2_90(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pre_gd();
    } else if (jj_2_91(2)) {
      node = empty_or();
    } else if (jj_2_92(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp empty_or() throws ParseException {Token t = token;
    t = jj_consume_token(LEFT_BRACKET);
    jj_consume_token(RIGHT_BRACKET);
{if ("" != null) return new Exp(Connective.OR);}
    throw new Error("Missing return statement in function");
  }

  final public Exp and_pre_gd() throws ParseException {Token t = token;
...
{if ("" != null) return node;}
  ...
  final public Exp forall_pre_gd() throws ParseException {Exp node = new Exp(Connective.FORALL);
...
node.setVariables(vars);
  ...
  final public Exp pref_gd() throws ParseException {Symbol pref_name = null;
        Exp node = null;
    left_bracket();
...
node.setPrefName(pref_name);
  ...
  final public Symbol pref_name() throws ParseException {Token t = null;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.PREFERENCE, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp effect() throws ParseException {Exp node = null;
    if (jj_2_94(2)) {
      node = and_c_effect();
    } else if (jj_2_95(2)) {
      node = c_effect();
...
{if ("" != null) return node;}
  ...
  final public Exp and_c_effect() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp s = null;
    left_bracket();
    jj_consume_token(AND);
    label_21:
...
{if ("" != null) return node;}
  ...
  final public Exp c_effect() throws ParseException {Exp node = null;
    if (jj_2_97(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_98(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
...
{if ("" != null) return node;}
  ...
  final public Exp forall_effect() throws ParseException {Exp node = new Exp(Connective.FORALL);
        List<TypedSymbol> vars = null;
        Exp s = null;
    left_bracket();
    jj_consume_token(FORALL);
...
node.setVariables(vars);
  ...
  final public Exp when_con_effect() throws ParseException {Exp node = new Exp(Connective.WHEN);
        Exp condition = null;
        Exp effects = null;
    left_bracket();
...
node.addChild(condition);
  ...
  final public Exp cond_effect() throws ParseException {Exp node = null;
    if (jj_2_100(2)) {
      node = and_p_effect();
    } else if (jj_2_101(2)) {
      node = p_effect();
...
{if ("" != null) return node;}
  ...
  final public Exp and_p_effect() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp s = null;
    left_bracket();
    jj_consume_token(AND);
    label_22:
...
{if ("" != null) return node;}
  ...
  final public Exp p_effect() throws ParseException {Exp node = null;
    if (jj_2_103(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = assign_op();
    } else if (jj_2_104(2) && (this.isRequirement(RequireKey.ACTION_COSTS))) {
...
{if ("" != null) return node;}
  ...
  final public Exp increase_total_cost() throws ParseException {Exp node = new Exp(Connective.INCREASE);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp total_cost() throws ParseException {Token t;
    jj_consume_token(LEFT_BRACKET);
    t = jj_consume_token(TOTAL_COST);
    jj_consume_token(RIGHT_BRACKET);
Exp node = new Exp(Connective.FN_HEAD);
  ...
  final public Exp numeric_term() throws ParseException {List<Symbol> tokenList = new ArrayList<Symbol>();
        Symbol s = null;
        Exp node = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFT_BRACKET:{
...
{if ("" != null) return node;}
  ...
  final public Exp assign_op() throws ParseException {Exp node = null;
    if (jj_2_107(2)) {
      node = assign();
    } else if (jj_2_108(2)) {
      node = scale_up();
...
{if ("" != null) return node;}
  ...
  final public Exp assign() throws ParseException {Exp node = new Exp(Connective.ASSIGN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp scale_up() throws ParseException {Exp node = new Exp(Connective.SCALE_UP);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp scale_down() throws ParseException {Exp node = new Exp(Connective.SCALE_DOWN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Exp increase() throws ParseException {Exp node = new Exp(Connective.INCREASE);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(INCREASE);
...
node.addChild(op1);
  ...
  final public Exp decrease() throws ParseException {Exp node = new Exp(Connective.DECREASE);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
...
node.addChild(op1);
  ...
  final public Op durative_action_def() throws ParseException {Symbol name = null;
        List<TypedSymbol> parameters = null;
        Exp duration = null;
        Exp condition = null;
        Exp effect = null;
...
{if ("" != null) return new Op(name, parameters, condition, effect, duration);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol da_symbol() throws ParseException {Token t = null;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.ACTION, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp duration_constraint() throws ParseException {Exp node = null;
    if (jj_2_112(2)) {
      node = empty_or();
    } else if (jj_2_113(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
...
{if ("" != null) return node;}
  ...
  final public Exp and_simple_duration_constraint() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp child = null;
    left_bracket();
    jj_consume_token(AND);
    label_24:
...
{if ("" != null) return node;}
  ...
  final public Exp simple_duration_constraint() throws ParseException {Exp node = null;
    if (jj_2_116(2)) {
      node = d_op();
    } else if (jj_2_117(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp at_simple_duration_constraint() throws ParseException {Exp node = null;
    if (jj_2_118(3)) {
...
{if ("" != null) return node;}
  ...
  final public Exp at_start_simple_duration_constraint() throws ParseException {Exp node = new Exp(Connective.AT_START);
        Exp child;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(START);
...
node.addChild(child);
  ...
  final public Exp at_end_simple_duration_constraint() throws ParseException {Exp node = new Exp(Connective.AT_END);
        Exp child;
    jj_consume_token(LEFT_BRACKET);
    jj_consume_token(AT);
    jj_consume_token(END);
...
node.addChild(child);
  ...
  final public Exp d_op() throws ParseException {Exp node = null;
    if (jj_2_120(2)) {
      node = equal_d_op();
    } else if (jj_2_121(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
    } else if (jj_2_122(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = lequal_d_op();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp equal_d_op() throws ParseException {Exp node = new Exp(Connective.EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(EQUAL);
...
node.addChild(op1);
  ...
  final public Exp gequal_d_op() throws ParseException {Exp node = new Exp(Connective.GREATER_OR_EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    jj_consume_token(LEFT_BRACKET);
    jj_consume_token(GEQUAL);
...
node.addChild(op1);
  ...
  final public Exp lequal_d_op() throws ParseException {Exp node = new Exp(Connective.LESS_OR_EQUAL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(LEQUAL);
...
node.addChild(op1);
  ...
  final public Exp var_duration() throws ParseException {Exp node = new Exp(Connective.TIME_VAR);
        Token t = null;
...
node.setVariable(new Symbol(Symbol.Kind.DURATION_VARIABLE, t));
  ...
  final public Exp d_value() throws ParseException {Exp node = null;
    if (jj_2_123(2)) {
      node = number();
    } else if (jj_2_124(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_exp();
    } else {
...
{if ("" != null) return node;}
  ...
  final public Exp da_gd() throws ParseException {Exp node = null;
    if (jj_2_125(2)) {
      node = pref_timed_gd();
    } else if (jj_2_126(2)) {
      node = and_da_gd();
    } else if (jj_2_127(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp forall_da_gd() throws ParseException {Exp node = new Exp(Connective.FORALL);
        Exp child = null;
        List<TypedSymbol> typedList = null;
    jj_consume_token(LEFT_BRACKET);
    jj_consume_token(FORALL);
...
node.setVariables(typedList);
  ...
  final public Exp and_da_gd() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp child = null;
    jj_consume_token(LEFT_BRACKET);
    jj_consume_token(AND);
    label_25:
...
{if ("" != null) return node;}
  ...
  final public Exp pref_timed_gd() throws ParseException {Exp node = null;
    if (jj_2_129(2)) {
      node = timed_gd();
    } else if (jj_2_130(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
...
{if ("" != null) return node;}
  ...
  final public Exp named_pref_timed_gd() throws ParseException {Symbol pref_name = null;
        Exp node = null;
    left_bracket();
    jj_consume_token(PREFERENCE);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
node.setPrefName(pref_name);
  ...
  final public Exp timed_gd() throws ParseException {Exp node = null;
    if (jj_2_131(2)) {
      node = at_timed_gd();
    } else if (jj_2_132(2)) {
      node = over_timed_gd();
...
{if ("" != null) return node;}
  ...
  final public Exp over_timed_gd() throws ParseException {Exp node = new Exp(Connective.OVER_ALL);
        Exp child = null;
    left_bracket();
...
node.addChild(child);
  ...
  final public Exp at_timed_gd() throws ParseException {Exp node = null;
    if (jj_2_133(3)) {
...
{if ("" != null) return node;}
  ...
  final public Exp at_start_timed_gd() throws ParseException {Exp node = new Exp(Connective.AT_START);
        Exp child = null;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(START);
...
node.addChild(child);
  ...
  final public Exp at_end_timed_gd() throws ParseException {Exp node = new Exp(Connective.AT_END);
        Exp child = null;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(END);
...
node.addChild(child);
  ...
  final public Exp da_effect() throws ParseException {Exp node = null;
    if (jj_2_135(2)) {
      node = and_da_effect();
    } else if (jj_2_136(2)) {
      node = timed_effect();
    } else if (jj_2_137(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_da_effect();
    } else if (jj_2_138(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = when_da_effect();
    } else if (jj_2_139(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = da_assign_op();
    } else {
...
{if ("" != null) return node;}
  ...
  final public Exp da_assign_op() throws ParseException {Exp node = null;
    if (jj_2_140(2)) {
      node = da_assign();
    } else if (jj_2_141(2)) {
      node = da_scale_up();
...
{if ("" != null) return node;}
  ...
  final public Exp da_assign() throws ParseException {Exp node = new Exp(Connective.ASSIGN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(ASSIGN);
...
node.addChild(op1);
  ...
  final public Exp da_scale_up() throws ParseException {Exp node = new Exp(Connective.SCALE_UP);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(SCALE_UP);
...
node.addChild(op1);
  ...
  final public Exp da_scale_down() throws ParseException {Exp node = new Exp(Connective.SCALE_DOWN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(SCALE_DOWN);
...
node.addChild(op1);
  ...
  final public Exp da_increase() throws ParseException {Exp node = new Exp(Connective.INCREASE);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(INCREASE);
...
node.addChild(op1);
  ...
  final public Exp da_decrease() throws ParseException {Exp node = new Exp(Connective.DECREASE);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(DECREASE);
...
node.addChild(op1);
  ...
  final public Exp when_da_effect() throws ParseException {Exp node = new Exp(Connective.WHEN);
        Exp condition = null;
        Exp effect = null;
    left_bracket();
    jj_consume_token(WHEN);
...
node.addChild(condition);
  ...
  final public Exp forall_da_effect() throws ParseException {Exp node = new Exp(Connective.FORALL);
        List<TypedSymbol> typedList = null;
        Exp child = null;
    left_bracket();
    jj_consume_token(FORALL);
...
node.setVariables(typedList);
  ...
  final public Exp and_da_effect() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp child = null;
    left_bracket();
    jj_consume_token(AND);
    label_26:
...
{if ("" != null) return node;}
  ...
  final public Exp timed_effect() throws ParseException {Exp node = null;
    if (jj_2_156(2)) {
      node = at_a_effect();
    } else if (jj_2_157(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp at_f_assign_da() throws ParseException {Exp node = null;
    if (jj_2_158(3)) {
...
{if ("" != null) return node;}
  ...
  final public Exp at_start_f_assign_da() throws ParseException {Exp node = new Exp(Connective.AT_START);
        Exp child;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(START);
...
node.addChild(child);
  ...
  final public Exp at_end_f_assign_da() throws ParseException {Exp node = new Exp(Connective.AT_END);
        Exp child;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(END);
...
node.addChild(child);
  ...
  final public Exp at_a_effect() throws ParseException {Exp node = null;
    if (jj_2_160(4)) {
...
{if ("" != null) return node;}
  ...
  final public Exp a_effect() throws ParseException {Exp node = null;
    if (jj_2_162(2)) {
      node = f_assign_da();
    } else if (jj_2_163(2)) {
      node = literal(Lexer.TERM);
...
{if ("" != null) return node;}
  ...
  final public Exp at_start_a_effect() throws ParseException {Exp node = new Exp(Connective.AT_START);
        Exp child = null;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(START);
...
node.addChild(child);
  ...
  final public Exp at_end_a_effect() throws ParseException {Exp node = new Exp(Connective.AT_END);
        Exp child = null;
    left_bracket();
    jj_consume_token(AT);
    jj_consume_token(END);
...
node.addChild(child);
  ...
  final public Exp assign_op_t() throws ParseException {Exp node = null;
    if (jj_2_166(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp increase_assign_op_t() throws ParseException {Exp node = new Exp(Connective.ASSIGN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(INCREASE);
...
node.addChild(op1);
  ...
  final public Exp decrease_assign_op_t() throws ParseException {Exp node = new Exp(Connective.ASSIGN);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(DECREASE);
...
node.addChild(op1);
  ...
  final public Exp f_exp_t() throws ParseException {Exp node = new Exp(Connective.F_EXP_T);
...
node.setVariable(continuous_variable_name);
  ...
  final public Symbol continuous_variable() throws ParseException {Token t = null;
    t = jj_consume_token(CONTINUOUS_VARIABLE);
{if ("" != null) return new Symbol(Symbol.Kind.CONTINUOUS_VARIABLE, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp f_assign_da() throws ParseException {Exp node = null;
    if (jj_2_171(2)) {
      node = da_assign();
    } else if (jj_2_172(2)) {
      node = da_scale_up();
...
{if ("" != null) return node;}
  ...
  final public Exp f_exp_da() throws ParseException {Exp node = null;
    if (jj_2_176(2)) {
      node = da_op();
    } else if (jj_2_177(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = var_duration();
    } else if (jj_2_178(2)) {
      node = f_exp();
    } else {
...
{if ("" != null) return node;}
  ...
  final public Exp da_op() throws ParseException {Exp node = null;
    if (jj_2_179(2)) {
      node = da_add_op();
    } else if (jj_2_180(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp da_add_op() throws ParseException {Exp node = new Exp(Connective.PLUS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(ADD);
...
node.addChild(op1);
  ...
  final public Exp da_substract_op() throws ParseException {Exp node = new Exp(Connective.MINUS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(SUB);
...
node.addChild(op1);
  ...
  final public Exp da_multiply_op() throws ParseException {Exp node = new Exp(Connective.MUL);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(MUL);
...
node.addChild(op1);
  ...
  final public Exp da_divide_op() throws ParseException {Exp node = new Exp(Connective.DIV);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(DIV);
...
node.addChild(op1);
  ...
  final public void problem() throws ParseException {Symbol name = null;
    try {
      left_bracket();
      jj_consume_token(DEFINE);
      left_bracket();
...
this.problem = new Problem(name);
      ...
      if (jj_2_196(2) && (this.isRequirement(RequireKey.HTN))) {
        htn_const();
      } else {
        ;
      }
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Symbol problem_name() throws ParseException {Token t = null;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.PROBLEM, t);}
    throw new Error("Missing return statement in function");
  }

  final public void domain_problem_name() throws ParseException {Token t = null;
    t = jj_consume_token(SYMBOL);
this.problem.setDomain(new Symbol(Symbol.Kind.DOMAIN, t));
  }

  final public Symbol domain_name() throws ParseException {Token t = null;
    t = jj_consume_token(SYMBOL);
{if ("" != null) return new Symbol(Symbol.Kind.DOMAIN, t);}
    throw new Error("Missing return statement in function");
  }

  final public void object_declaration() throws ParseException {List<TypedSymbol> typedList = null;
    try {
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void init() throws ParseException {Exp node = null;
    try {
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp init_el() throws ParseException {Exp node = null;
    if (jj_2_199(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_200(2)) {
      node = literal(Lexer.CONSTANT);
    } else if (jj_2_201(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS)
                            || this.isRequirement(RequireKey.ACTION_COSTS))) {
      node = equal_init_el();
...
{if ("" != null) return node;}
  ...
  final public Exp equal_init_el() throws ParseException {Exp node = new Exp(Connective.FN_ATOM);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(EQUAL);
...
node.addChild(op1);
  ...
  final public Exp timed_literal() throws ParseException {Exp node = new Exp(Connective.DURATION_ATOM);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(AT);
...
node.addChild(op1);
  ...
  final public void goal() throws ParseException {
    ...
    if (jj_2_202(2)) {
      pddl_goal();
    } else if (jj_2_203(2) && (this.isRequirement(RequireKey.HTN))) {
      htn_goal();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public void htn_goal() throws ParseException {Exp node = null;
    try {
      left_bracket();
      node = task_list();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void pddl_goal() throws ParseException {Exp node = null;
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void pddl_const(int type) throws ParseException {Exp conGD = null;
    try {
      jj_consume_token(LEFT_BRACKET);
      jj_consume_token(CONSTRAINTS);
      conGD = pref_con_gd();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void htn_const() throws ParseException {Exp constraints = null;
    try {
      left_bracket();
      jj_consume_token(CONSTRAINTS);
      left_bracket();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp pref_con_gd() throws ParseException {Exp node = null;
    if (jj_2_204(2)) {
      node = and_pref_con_gd();
    } else if (jj_2_205(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pref_con_gd();
    } else if (jj_2_206(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
...
{if ("" != null) return node;}
  ...
  final public Exp and_pref_con_gd() throws ParseException {Exp node = new Exp(Connective.AND);
        Exp child;
    left_bracket();
    jj_consume_token(AND);
    label_28:
...
{if ("" != null) return node;}
  ...
  final public Exp named_pref_con_gd() throws ParseException {Exp node = null;
...
node.setPrefName(pref_name);
  ...
  final public Exp forall_pref_con_gd() throws ParseException {Exp node = new Exp(Connective.FORALL);
        List<TypedSymbol> typedList = null;
        Exp child = null;
    left_bracket();
    jj_consume_token(FORALL);
...
node.setVariables(typedList);
  ...
  final public void metric_spec() throws ParseException {Exp node = null;
    try {
      if (jj_2_209(3)) {
        node = maximize();
      } else if (jj_2_210(3)) {
...
this.problem.setMetric(node);
  ...
  final public Exp maximize() throws ParseException {Exp node = new Exp(Connective.MAXIMIZE);
        Exp child = null;
    left_bracket();
...
node.addChild(child);
  ...
  final public Exp minimize() throws ParseException {Exp node = new Exp(Connective.MINIMIZE);
        Exp child = null;
    left_bracket();
    jj_consume_token(METRIC);
...
node.addChild(child);
  ...
  final public Exp metric_f_exp() throws ParseException {Exp node = null;
    if (jj_2_211(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp violated_pref_exp() throws ParseException {Exp node = new Exp(Connective.IS_VIOLATED);
        Symbol pref_name = null;
    left_bracket();
...
node.setPrefName(pref_name);
  ...
  final public Exp constant_f_head() throws ParseException {Exp node = new Exp(Connective.FN_HEAD);
        List<Symbol> function = new ArrayList<Symbol>();
        Symbol functor = null;
...
node.setAtom(function);
  ...
  final public Exp total_time() throws ParseException {Exp node = new Exp(Connective.FN_HEAD);
        Token t;
    if (jj_2_217(3)) {
      left_bracket();
...
List<Symbol> atom = new ArrayList<Symbol>();
  ...
  final public Exp op_metric_f_exp() throws ParseException {Exp node = null;
    if (jj_2_219(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp add_op_metric_f_exp() throws ParseException {Exp node = new Exp(Connective.PLUS);
        Exp op = null;
    left_bracket();
    jj_consume_token(ADD);
    op = metric_f_exp();
...
{if ("" != null) return node;}
  ...
  final public Exp substract_op_metric_f_exp() throws ParseException {Exp node = new Exp(Connective.MINUS);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(SUB);
...
node.addChild(op1);
  ...
  final public Exp div_op_metric_f_exp() throws ParseException {Exp node = new Exp(Connective.DIV);
        Exp op1 = null;
        Exp op2 = null;
    left_bracket();
    jj_consume_token(DIV);
...
node.addChild(op1);
  ...
  final public Exp multi_op_metric_f_exp() throws ParseException {Exp node = new Exp(Connective.MUL);
        Exp op = null;
    left_bracket();
    jj_consume_token(MUL);
    op = metric_f_exp();
...
{if ("" != null) return node;}
  ...
  private boolean jj_3R_150()
 {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_137()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.CONDITIONAL_EFFECTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_138()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_139()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_176()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_205()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_206()) {
    jj_scanpos = xsp;
  ...
  private boolean jj_3R_129()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_130()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_132()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_127()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_70()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_49()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_168()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_201()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_120()
 {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_121()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.DURATION_INEQUALITIES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_122()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_38()
 {
    ...
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.HTN);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_71()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_73()) return true;
    }
    }
    }
    return false;
  ...
  private boolean jj_3R_140()
 {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_157()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_142()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x2000,0x2000,0x0,0x2000,0x0,0x2000,0x0,0x0,0x2000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xfffffe00,0xfffffe00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x58000,0x4000f,0x20000,0x58000,0x58000,0x4000f,0x4000f,0x4004f,0x0,0x4000f,0x6000f,0x6000f,0x80000,0x4004f,0x6000f,0x0,0x0,0x40000,0x40000,0x40000,0x80000,0x40000,0x40000,0x80020,};
   }

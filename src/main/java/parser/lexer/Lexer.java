...
//			}
  ...
  final public Symbol primitive_type() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
                ...
                {if (true) return new Symbol(Symbol.Kind.TYPE, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol constant() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
                ...
                {if (true) return new Symbol(Symbol.Kind.CONSTANT, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol predicate() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
                ...
                {if (true) return new Symbol(Symbol.Kind.PREDICATE, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol variable() throws ParseException {
    ...
    t = jj_consume_token(VARIABLE_SYMBOL);
                              {if (true) return new Symbol(Symbol.Kind.VARIABLE, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol functor() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
            ...
            {if (true) return new Symbol(Symbol.Kind.FUNCTOR, t);}
    throw new Error("Missing return statement in function");
  }

  final public List<NamedTypedList> function_typed_list(int type) throws ParseException {
...
}
{
  ...
  final public Exp literal(int type) throws ParseException {
        Exp node = null;
    if (jj_2_54(2)) {
  ...
  final public DerivedPredicate derived_def() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(RIGHT_BRACKET);
                ...
                {if (true) return new DerivedPredicate(head, body);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Op action_def() throws ParseException {
    ...
    try {
      ...
      right_bracket();
                ...
                {if (true) return new Op(name, parameters, preconds, effects);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol action_name() throws ParseException {
        Token t = token;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.ACTION, t);}
    throw new Error("Missing return statement in function");
  }

  final public Method method_def() throws ParseException {
        Symbol name = null;
        List<TypedSymbol> parameters = null;
        Exp tasks = null;
    ...
    try {
      ...
      right_bracket();
                ...
                {if (true) return new Method(name, parameters, tasks, constraints);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol method_name() throws ParseException {
        Token t = token;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.METHOD, t);}
    throw new Error("Missing return statement in function");
  }

  final public Symbol task_name() throws ParseException {
        Token t = token;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.TASK, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp task_def() throws ParseException {
    Symbol name = null;
    Symbol alias = null;
  ...
  final public List<Symbol> task_parameters() throws ParseException {
        List<Symbol> atom = new ArrayList<Symbol>();
        Symbol t = null;
    label_16:
    while (true) {
  ...
  final public Exp task_list() throws ParseException {
  ...
  final public Exp htn_constraints() throws ParseException {
  ...
  final public Exp task_const() throws ParseException {
        Exp node = null;
    if (jj_2_74(2)) {
      node = htn_before();
    } else if (jj_2_75(2)) {
  ...
  final public Exp htn_before() throws ParseException {
  ...
  final public Exp htn_hold_before() throws ParseException {
  ...
  final public Exp htn_hold_after() throws ParseException {
  ...
  final public Exp htn_hold_between() throws ParseException {
  ...
  final public Exp htn_hold_during() throws ParseException {
  ...
  final public Exp htn_at_start() throws ParseException {
  ...
  final public Exp htn_at_end() throws ParseException {
  ...
  final public Exp htn_within() throws ParseException {
  ...
  final public Exp htn_always_within() throws ParseException {
  ...
  final public Symbol alias_name() throws ParseException {
        Token t = token;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.ALIAS, t);}
    throw new Error("Missing return statement in function");
  }

  final public Exp alias_set() throws ParseException {
  ...
  final public Exp empty_or() throws ParseException {
    ...
    t = jj_consume_token(LEFT_BRACKET);
    jj_consume_token(RIGHT_BRACKET);
                {if (true) return new Exp(Connective.OR);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol pref_name() throws ParseException {
        Token t = null;
    t = jj_consume_token(SYMBOL);
                {if (true) return new Symbol(Symbol.Kind.PREFERENCE, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Op durative_action_def() throws ParseException {
    ...
    try {
      ...
      right_bracket();
                ...
                {if (true) return new Op(name, parameters, condition, effect, duration);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Symbol continuous_variable() throws ParseException {
    ...
    t = jj_consume_token(CONTINUOUS_VARIABLE);
                {if (true) return new Symbol(Symbol.Kind.CONTINUOUS_VARIABLE, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token t = null;
    t = jj_consume_token(SYMBOL);
                      {if (true) return new Symbol(Symbol.Kind.PROBLEM, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token t = null;
    t = jj_consume_token(SYMBOL);
                     {if (true) return new Symbol(Symbol.Kind.DOMAIN, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public void htn_goal() throws ParseException {
        Exp node = null;
    try {
      left_bracket();
      node = task_list();
  ...
  final public void pddl_goal() throws ParseException {
        Exp node = null;
  ...
  final public void pddl_const(int type) throws ParseException {
        Exp conGD = null;
    try {
      jj_consume_token(LEFT_BRACKET);
      jj_consume_token(CONSTRAINTS);
  ...
  final public void htn_const() throws ParseException {
        Exp constraints = null;
    try {
      left_bracket();
      jj_consume_token(CONSTRAINTS);
  ...
  final public Exp pref_con_gd() throws ParseException {
    ...
    if (jj_2_204(2)) {
      ...
      node = forall_pref_con_gd();
        ...
        System.out.println("doing a named preference");
  ...
  final public Exp named_pref_con_gd() throws ParseException {
    ...
    right_bracket();
                node.setPrefName(pref_name);
                System.out.println("setting name " + pref_name.toString() + "\n");
                {if (true) return node;}
    throw new Error("Missing return statement in function");
  }
